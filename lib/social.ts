...
const allSocialLinks: SocialLink[] = [
  { network: "facebook", href: "https://www.facebook.com/satitsomsangium", label: "Facebook" },
  { network: "x", href: "https://x.com/SatitSomsangium", label: "X (Twitter)" },
  // { network: "github", href: "https://github.com/", label: "GitHub" },
  // { network: "youtube", href: "https://www.youtube.com/", label: "YouTube" },
  { network: "instagram", href: "https://www.instagram.com/satitsomsangium/", label: "Instagram" },
